...
transformer_weights = np.load(os.path.join(SCRIPT_DIR, 'nnue_data', 'transformer_weights.npy'))
transformer_bias = np.load(os.path.join(SCRIPT_DIR, 'nnue_data', 'transformer_bias.npy'))
